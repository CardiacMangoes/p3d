...
from base_model import NovelViewSynthesisModel
...
class OpenLRM(NovelViewSynthesisModel):
    ...
    def process_image(self, image):
        canonical_rotation = torch.tensor([[1, 0, 0],[0, 0, -1],[0, 1, 0]], dtype=torch.float32)
        ...
        self.image = image
        self.latent_repr = self.model.forward_planes(image, source_camera)
    ...
    def generate_image(self, camera_coordinates):
        ...
        frames = []
        for i in range(0, camera_coordinates.shape[1], 1):
